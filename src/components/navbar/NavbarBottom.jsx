                ...
                <div className="navbarBottom">
                    ...
                    <div className="navbarBottom-category-section">
                        <button className='navbarBottom-category-section-btn'>
                            <svg className='burger-ico' width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg"> <rect width="16" height="2" rx="1" transform="matrix(-1 0 0 1 16 0)" fill="white" /> <rect width="20" height="2" rx="1" transform="matrix(-1 0 0 1 20 7)" fill="white" /> <rect width="16" height="2" rx="1" transform="matrix(-1 0 0 1 16 14)" fill="white" /> </svg>
